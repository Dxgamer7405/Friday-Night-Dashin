function onCreate()
	...
	setScrollFactor('back', 0.9, 0.1);
      ...
      makeAnimatedLuaSprite('grass','grassBG',-470,-900)
      addAnimationByPrefix('grass','dance','grassBG',24,true)
      objectPlayAnimation('grass','dance',false)
      setScrollFactor('grass', 0.9, 0.9);

      makeAnimatedLuaSprite('scenario','scenarioBG',-390,-100)
      addAnimationByPrefix('scenario','dance','scenarioBG',24,true)
	...
	if not lowQuality then
		...
		makeAnimatedLuaSprite('robot','ultraviolenceRobot',1070,-900)
		addAnimationByPrefix('robot','dance','ultraviolenceRobot',24,true)
      	objectPlayAnimation('robot','dance',false)
      	setScrollFactor('robot', 0.9, 0.9);

      	makeAnimatedLuaSprite('publicgeo','geometricalpublic',-470,-945)
      	addAnimationByPrefix('publicgeo','dance','public',24,true)
