function onCreate()
	-- background shit
      makeAnimatedLuaSprite('cavefnf','CaveBG',-700,-1100)
      addAnimationByPrefix('cavefnf','dance','CaveBG',24,true)
	...
	if not lowQuality then
		...
		setScrollFactor('back', 0.9, 0.9);
      	...
      	makeAnimatedLuaSprite('things','caveThings',-470,-1100)
      	addAnimationByPrefix('things','dance','caveThings',24,true)
		...
		setScrollFactor('calacaxd', 0.8, 1.0);
      	...
      	makeAnimatedLuaSprite('margen','MargenGD',-800,-1100)
      	addAnimationByPrefix('margen','dance','MargenGD',24,true)
