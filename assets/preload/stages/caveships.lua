function onCreate()
	-- background shit
   	 makeAnimatedLuaSprite('frontBG','strikerBGfront',-3050,-770)
	   addAnimationByPrefix('frontBG','dance','strikerBGfront',24,true)
     objectPlayAnimation('frontBG','dance',false)
     setScrollFactor('frontBG', 0.9, 0.9);

     makeAnimatedLuaSprite('backBG','strikerBGback',-3050,-770)
     addAnimationByPrefix('backBG','dance','strikerBGback',24,true)
     objectPlayAnimation('backBG','dance',false)
     setScrollFactor('backBG', 0.9, 0.9);

     makeAnimatedLuaSprite('FASTfrontBG','FASTstrikerBGfront',-3050,-770)
     addAnimationByPrefix('FASTfrontBG','dance','FASTstrikerBGfront',24,true)
